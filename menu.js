...
const fooditem = [
    {
        FoodName: "Pancakes",
        foodimg: 'pancakes-2291908_1280.jpg',
        price: "RS 250",
        category: "Breakfast",
    ...
    {
        FoodName: "Chicken",
        foodimg: '0cc225da421b2748f600aa18c9bd8529.jpg',
        price: "RS 400",
        category: "Lunch",
    ...
    },
    {
        ...
        foodimg: 'TROPICAL-FRUIT-SALAD-SQUARE.jpg',
        price: "RS 600",
        category: "Dinner",
...
function displayFood(item) {
    ...
    <div class="product-des">
        <h5>${item[i].FoodName} <span>${item[i].price}</span> </h5>
